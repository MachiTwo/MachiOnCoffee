...
> [!IMPORTANT] > **Core System Interno** | O Harness não é uma camada de auditoria externa, mas sim o "sistema nervoso
> central" do Vectora Agent. Ele fornece ao modelo o contexto sobre suas próprias ferramentas e garante que todos os
> processos operacionais sejam seguidos sem erros.
...
Hoje, times e desenvolvedores "acham" que um agent ou ferramenta de contexto melhorou, mas raramente têm métricas
objetivas para provar. O **Vectora Harness** entrega essa prova, internalizando a lógica operacional:
...
> ✅ **Ele governa o comportamento operacional, o uso correto de contexto e a segurança de execução de dentro para
> fora.**
...
> ⚠️ **Regra de Ouro**: Se a nota de **Segurança** for menor que o limite, o teste falha imediatamente com score
> **0.0**, protegendo o sistema contra comportamentos perigosos.
...
**Verificação Objetiva**: Use `must_include` e `blocked_tools` para critérios irrefutáveis. ✅ **Isole Namespaces**:
Sempre use tags de `namespace` para garantir que o contexto não vaze entre testes. ✅ **Documente o 'Porquê'**: Adicione
comentários no YAML explicando a intenção do teste para facilitar a manutenção.

---

> 💡 **Frase para guardar**:  
> _"O Harness não substitui o julgamento humano. Ele transforma intuição em evidência, permitindo que você evolua o
> sistema nervoso do seu agent com confiança absoluta."_
