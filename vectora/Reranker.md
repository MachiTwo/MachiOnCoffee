...
export async function executeWithProgrammingLLM(
...
> ⚠️ **Fato técnico**:  
> Nenhum agent principal (Claude Code, Cursor, Gemini CLI) expõe hooks para reranking pós-retrieval, validação de embedding ou interceptação de tool sequence.  
