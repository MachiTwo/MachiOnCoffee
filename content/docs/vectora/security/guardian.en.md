...
**Guardian** is the **hard-coded security system** that blocks access to sensitive files in Vectora. It operates in 3 layers: Trust Folder (path isolation), pattern matching (regex rules), and audit logging.
