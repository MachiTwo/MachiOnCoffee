...
**RBAC** (Role-Based Access Control) é o sistema de permissões granulares em Vectora. 5 roles hierárquicos, 15 permissões específicas, nível de usuário + namespace.
