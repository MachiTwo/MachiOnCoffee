...
| -------------- | ------------------------------------- | ---------- |
| **MCP**        | Agent runs locally in Go/Rust         |            |
| **REST API**   | Remote agent in Python/Node/Go        |            |
...
> Need a specific integration? [Open an Issue](https://github.com/vectora/vectora/issues)
