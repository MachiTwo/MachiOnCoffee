...
- [**⚙️ RefCounted**](classes/refcounted/) — Runtime executors and state utilities.
- [**🎮 Behavior Tree**](classes/behavior-tree/) — Native integration with LimboAI.
- [**✏️ Editor**](classes/editor/) — Tag panels and custom inspectors.
...
v0.1.0 Stable | Godot 4.6+ | Dual-Build (GDExtension/Module) | Developed with ❤️ by MachiTwo
